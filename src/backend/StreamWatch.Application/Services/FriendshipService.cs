        ...
        var friends = await _context.Friendships
            ...
            .Select(f => f.AddresseeId == currentUserId
                ? new FriendModel(
                    ...
                    new MediaModel(f.Requester.ProfilePic.FileName, f.Requester.ProfilePic.FileName),
                    f.ResponseDate
                )
                : new FriendModel(
                    f.Addressee.UserName,
                    new MediaModel(f.Addressee.ProfilePic.FileName, f.Addressee.ProfilePic.FileName),
                    f.ResponseDate
                )
            )
            .ToListAsync();
