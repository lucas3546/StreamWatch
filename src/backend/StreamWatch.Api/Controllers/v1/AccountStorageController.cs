...
public class AccountStorageController : ControllerBase
{
    ...
    [SwaggerOperation(Summary = "Genereate a presigned url", Description = "Generate presigned url to upload files on S3 Bucket, NOTE: This don't work when the storage is set to Local")]
